...
knowledge2 = And(
    ...
    Or(And(BKnave, Or(And(AKnight, BKnight), And(AKnave, BKnave))), And(BKnight, Not(Or(And(AKnight, BKnight), And(AKnave, BKnave))))),
    Or(And(BKnave, Not(BKnight)), And(Not(BKnave), BKnight)),
    Or(And(AKnave, Not(AKnight)), And(Not(AKnave), AKnight)),
)
...
knowledge3 = And(
    Or(And(BKnight, Or(And(AKnave, Not(AKnave)), And(AKnight, AKnave))), And(BKnave, Not(Or(And(AKnave, Not(AKnave)), And(AKnight, AKnave))))),
